...
class NewsletterSubscribeShortCode
{
    ...
    public function subscribeShortCode()
    {
        ...
        list($submitted, $email, $email_wrong, $except_privacy_policy, $hondypod_valid, $success) = $this->handleFormSubmit();
...
<form method="post" action="#newsletter" id="newsletter-form">
                ...
                <div class="form-group">
                    ...
                    <input  type="email" class="form-control" name="email" style="display:none !important" tabindex="-1" autocomplete="off" value="" id="email" value="' . $email . '"
                           aria-describedby="emailHelp" placeholder="Ihre E-Mail Adresse">
    ...
    public function is_honeypod_valid(){
    ...
    public function handleFormSubmit()
    {
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST") {
            ...
            $honeypod_valid = $this->is_honeypod_valid();

            $sendAcknowledgementMail = false;
            if (!$email_wrong && $except_privacy_policy && $honeypod_valid) {
        ...
        return array($submitted, $email, $email_wrong, $except_privacy_policy,$honeypod_valid, $success);
    }
